...
import { RecipeHubContext } from '../App';

const Meal PlanScreen = ({ navigation }) => {
  const { theme } = useContext(RecipeHubContext);
        ...
        <View style={styles.grid}>
          <View style={[styles.card, { backgroundColor: theme.colors.card }]}>
            ...
            <Text style={[styles.cardText, { color: '#CCC' }]}>
              Recipe Hub feature description
            </Text>
          </View>
          <View style={[styles.card, { backgroundColor: theme.colors.card }]}>
            <Text style={[styles.cardTitle, { color: theme.colors.text }]}>
...
export default Meal PlanScreen;
